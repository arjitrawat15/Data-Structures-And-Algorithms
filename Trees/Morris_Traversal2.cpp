//to find the preorder of the binary tree using Morris traversal in O(1) Space complexity using the concept of threaded binary tree.
#include<bits/stdc++.h>
using namespace std;
struct node
{
...
void morris_traversal(node* root) // TC->O(N) SC->O(1)
{
    ...
    cout<<"Pre-order of binary tree using Morris traversal is: ";
